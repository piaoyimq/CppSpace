...
{	//purpose:read all sections name,result section name each end with '\0'
	...
	while ( GetLine(Buffer, constLINEBUFFERSIZE, delimENDOFLINE) )  {
		...
		if ( ReturnSection( Buffer, pResultBuf ) )	{ //find section
			if (pResultBuf) { //find ok
...
//////////////
void  TProfile::DeleteKey(char* pSection, char* pKey)
{
...
//////////////
void  TProfile::EraseSection(char* pSection) 
...
///////////////////////////////////////////////////////
int TProfile::ReadString( char* section, char* name, int index, char* buf )
{
...
int TProfile::ReadTString( char* section, char* name, int index, char* buf )
{
...
int TProfile::NewValueOfName( char* section, char* name, char* value )
{
//old:
...
int TProfile::WriteString( char* section, char* name, int index, char* buf )
{
        sprintf( Token, "%s", buf );
