...
public:
	...
	char* ReadString(const char* pSection, const char* pKey, const char* pDefault);
	//read total string
	char* ReadTString(const char* pSection, const char* pKey, const char* pDefault);
	void  WriteString(const char* pSection, const char* pKey, const char* pValue);
	void  WriteTString(const char* pSection, const char* pKey, const char* pValue);

	int   ReadInteger(const char* pSection, const char* pKey, const int nDefault);
...
//	bool  ReadBool(const char* pSection, const char* pKey, const bool Default);
	...
	double  ReadFloat(const char* pSection, const char* pKey, const double Default);
