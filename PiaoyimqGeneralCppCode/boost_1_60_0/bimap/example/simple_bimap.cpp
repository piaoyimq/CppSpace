...
//	std::cout << "The winner is " << results.right[1] << std::endl << std::endl;

	std::cout << "The winner is " << results.left.at("Spain") << std::endl << std::endl;
//	std::cout << "The winner is " << results.left["Spain"] << std::endl << std::endl;//??
	...
	std::cout << std::endl << "Countries names ordered alphabetically along with"
			"their final position:" << std::endl;
