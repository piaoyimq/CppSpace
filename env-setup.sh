...
then
    mkdir $BIN_PATH 
    ln -s $BASE_PATH/ShellSpace/PiaoyimqGeneralShellCode/shell-test/vim.sh $BIN_PATH/vim.sh 
    ln -s $BASE_PATH/ShellSpace/PiaoyimqGeneralShellCode/shell-test/vimdiff.sh $BIN_PATH/vimdiffsh 
else
    ln -s $BASE_PATH/ShellSpace/PiaoyimqGeneralShellCode/shell-test/vim.sh $BIN_PATH/vim.sh 
    ln -s $BASE_PATH/ShellSpace/PiaoyimqGeneralShellCode/shell-test/vimdiff.sh $BIN_PATH/vimdiffsh 
fi 
