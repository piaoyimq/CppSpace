/*
 * practicalSubMachineExample.cpp
 *
    ...
    struct Sm1_:msmf::state_machine_def<Sm1_>
    {
        ...
        struct ScanFinger_:msmf::state_machine_def<ScanFinger_>
        {
            ...
            struct Scanning:msmf::state<> {
                template <class Event,class Fsm>
                void on_entry(Event const&, Fsm&, typename boost::enable_if<boost::is_same<Event, boost::any> >::type* = 0) const {
            ...
            struct transition_table:mpl::vector<
                ...
                msmf::Row < ScanOnly,      boost::any,     Scanning, msmf::none, msmf::none >,
